...
INSERT INTO `SYS_MENU`
    (`ID`, `PID`, `TITLE`, `METHOD`, `URL`, `SORT`, `SYS_MENU`, `DISABLE`, `CREATE_USERNAME`, `CREATE_TIMESTAMP`)
VALUES (7, 2, '创建用户', 'POST', '/sys/user/create', 7, b'0', b'0', 'admin', now());
INSERT INTO `SYS_MENU`
    (`ID`, `PID`, `TITLE`, `METHOD`, `URL`, `SORT`, `SYS_MENU`, `DISABLE`, `CREATE_USERNAME`, `CREATE_TIMESTAMP`)
VALUES (8, 2, '修改用户', 'PUT', '/sys/user/update', 8, b'0', b'0', 'admin', now());
INSERT INTO `SYS_MENU`
    (`ID`, `PID`, `TITLE`, `METHOD`, `URL`, `SORT`, `SYS_MENU`, `DISABLE`, `CREATE_USERNAME`, `CREATE_TIMESTAMP`)
VALUES (9, 2, '删除用户', 'DELETE', '/sys/user/delete', 9, b'0', b'0', 'admin', now());
INSERT INTO `SYS_MENU`
    (`ID`, `PID`, `TITLE`, `METHOD`, `URL`, `SORT`, `SYS_MENU`, `DISABLE`, `CREATE_USERNAME`, `CREATE_TIMESTAMP`)
...
INSERT INTO `SYS_MENU`
    (`ID`, `PID`, `TITLE`, `METHOD`, `URL`, `SORT`, `SYS_MENU`, `DISABLE`, `CREATE_USERNAME`, `CREATE_TIMESTAMP`)
VALUES (14, 3, '创建角色', 'POST', '/sys/role/create', 14, b'0', b'0', 'admin', now());
INSERT INTO `SYS_MENU`
    (`ID`, `PID`, `TITLE`, `METHOD`, `URL`, `SORT`, `SYS_MENU`, `DISABLE`, `CREATE_USERNAME`, `CREATE_TIMESTAMP`)
VALUES (15, 3, '修改角色', 'PUT', '/sys/role/update', 15, b'0', b'0', 'admin', now());
INSERT INTO `SYS_MENU`
    (`ID`, `PID`, `TITLE`, `METHOD`, `URL`, `SORT`, `SYS_MENU`, `DISABLE`, `CREATE_USERNAME`, `CREATE_TIMESTAMP`)
VALUES (16, 3, '删除角色', 'DELETE', '/sys/role/delete', 16, b'0', b'0', 'admin', now());
...
INSERT INTO `SYS_MENU`
    (`ID`, `PID`, `TITLE`, `METHOD`, `URL`, `SORT`, `SYS_MENU`, `DISABLE`, `CREATE_USERNAME`, `CREATE_TIMESTAMP`)
VALUES (19, 4, '创建菜单', 'POST', '/sys/menu/create', 19, b'0', b'0', 'admin', now());
INSERT INTO `SYS_MENU`
    (`ID`, `PID`, `TITLE`, `METHOD`, `URL`, `SORT`, `SYS_MENU`, `DISABLE`, `CREATE_USERNAME`, `CREATE_TIMESTAMP`)
VALUES (20, 4, '修改菜单', 'PUT', '/sys/menu/update', 20, b'0', b'0', 'admin', now());
INSERT INTO `SYS_MENU`
    (`ID`, `PID`, `TITLE`, `METHOD`, `URL`, `SORT`, `SYS_MENU`, `DISABLE`, `CREATE_USERNAME`, `CREATE_TIMESTAMP`)
VALUES (21, 4, '删除菜单', 'DELETE', '/sys/menu/delete', 21, b'0', b'0', 'admin', now());
...
INSERT INTO `SYS_MENU`
    (`ID`, `PID`, `TITLE`, `METHOD`, `URL`, `SORT`, `SYS_MENU`, `DISABLE`, `CREATE_USERNAME`, `CREATE_TIMESTAMP`)
VALUES (23, 5, '删除日志', 'DELETE', '/sys/log/delete', 23, b'0', b'0', 'admin', now());
...
INSERT INTO `SYS_MENU`
    (`ID`, `PID`, `TITLE`, `METHOD`, `URL`, `SORT`, `SYS_MENU`, `DISABLE`, `CREATE_USERNAME`, `CREATE_TIMESTAMP`)
VALUES (25, 24, '创建通知公告', 'POST', '/sys/notice/create', 25, b'0', b'0', 'admin', now());
INSERT INTO `SYS_MENU`
    (`ID`, `PID`, `TITLE`, `METHOD`, `URL`, `SORT`, `SYS_MENU`, `DISABLE`, `CREATE_USERNAME`, `CREATE_TIMESTAMP`)
VALUES (26, 24, '修改通知公告', 'PUT', '/sys/notice/update', 26, b'0', b'0', 'admin', now());
INSERT INTO `SYS_MENU`
    (`ID`, `PID`, `TITLE`, `METHOD`, `URL`, `SORT`, `SYS_MENU`, `DISABLE`, `CREATE_USERNAME`, `CREATE_TIMESTAMP`)
VALUES (27, 24, '删除通知公告', 'DELETE', '/sys/notice/delete', 27, b'0', b'0', 'admin', now());